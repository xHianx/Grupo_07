...
import com.mycompany.borrador.DoubleLinkedList;
...
public class Vehiculos {
    ...
    private int precio, anio, kilometraje; //Poner mas de 20000 pero menos de 40000
    private String tipo; 
    private Combustible combus;
    private CircularDoublyLinkedList<String> imagenes;
    
    public Vehiculos(String marca, String modelo, int precio, tipoVehiculo tipo1, int anio, int kilometraje, Combustible combus, String tipo, String traccion, CircularDoublyLinkedList<String> imagenes) {
        this.marca = marca;
        this.modelo = modelo;
        this.precio = precio;
        this.tipo = tipo;
    ...
    public Vehiculos(String marca, String modelo, int precio, String tipo, int anio, int kilometraje, Combustible combus, String traccion, String transmision) {
        this.marca = marca;
        this.modelo = modelo;
        this.precio = precio;
        this.tipo = tipo;
    ...
    public String toString() {
        return "Vehiculos{" + "marca=" + marca + ", modelo=" + modelo + ", precio=" + precio + ", tipo=" + tipo + ", aniousado=" + anio + ", kilometraje=" + kilometraje + ", combustible=" + combus + ", traccion=" + traccion + ", transmision=" + transmision + '}';
    }
    ...
    public void guardarArchivo(String nomfile){
        try(BufferedWriter bw=new BufferedWriter(new FileWriter(nomfile));){
            bw.write(marca+","+modelo+","+String.valueOf(precio)+","+String.valueOf(tipo)+","+String.valueOf(anio)+","+String.valueOf(kilometraje)+","+combus.name()+","+traccion+","+transmision+"\n");
    ...
    public static void guardarArchivo(DoubleLinkedList<Vehiculos> vs,String nomfile){
        try(BufferedWriter bw=new BufferedWriter(new FileWriter(nomfile));){
            vs.forEach(vehi -> {try {
                bw.write(vehi.marca+","+vehi.modelo+","+String.valueOf(vehi.precio)+","+vehi.tipo+","+String.valueOf(vehi.anio)+","+String.valueOf(vehi.kilometraje)+","+vehi.combus.name()+","+vehi.traccion+","+vehi.transmision+"\n");
                } catch (IOException ex) {
                    ex.printStackTrace();
                }
            });
